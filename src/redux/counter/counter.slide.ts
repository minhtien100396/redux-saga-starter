...
export const counterSlice = createSlice({
    ...
    reducers: {
        ...
        // increaseSagaFinish: (state, action) => {
        //     state.status = "idle"
        ...
        // decreaseSagaFinish: (state, action) => {
        //     state.status = "idle"
        //     state.value -= action.payload.value;
        // },
...
export const { increment, decrement, incrementByAmount, increaseSagaStart, decreaseSagaStart } = counterSlice.actions
